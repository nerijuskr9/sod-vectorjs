...
describe('Ellipse', function () {
    describe('constructor', function () {
        it('should create a ellipse with a unique id and add it to the element controller', function () {
            let ellipse = new ellipse_js_1.default(100, 100, 100, 100);
            // chai.expect(ellipse.id).to.equal(`ellipse-0`);
            chai.expect(element_js_1.default.controller.get(ellipse.id)).to.equal(ellipse);
            // chai.expect(Element.count).to.equal(1);
        });
        it('should create elements with different identifiers', function () {
            let ellipse1 = new ellipse_js_1.default(100, 100, 100, 100);
            let ellipse2 = new ellipse_js_1.default(100, 100, 100, 100);
            chai.expect(element_js_1.default.controller.get(ellipse1.id)).to.equal(ellipse1);
            chai.expect(element_js_1.default.controller.get(ellipse2.id)).to.equal(ellipse2);
        });
    });
    describe('getters/setters', function () {
        it('should get x radius', function () {
            let radius = 100;
            let ellipse = new ellipse_js_1.default(100, 100, radius, 100);
        ...
        it('should get y radius', function () {
            let radius = 50;
            let ellipse = new ellipse_js_1.default(100, 100, 100, radius);
        ...
        it('should get x and y radius', function () {
            let xRadius = 50;
            let yRadius = 75;
            let ellipse = new ellipse_js_1.default(100, 100, xRadius, yRadius);
        ...
        it('should get cx', function () {
            let cx = 75;
            let ellipse = new ellipse_js_1.default(cx, 100, 100, 100);
        ...
        it('should get cy', function () {
            let cy = 50;
            let ellipse = new ellipse_js_1.default(100, cy, 100, 100);
