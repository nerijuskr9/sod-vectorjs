...
describe('Line', function () {
    describe('constructor', function () {
        it('should create a line with a unique id and add it to the element controller', function () {
            let line = new line_js_1.default(100, 100, 100, 100);
            chai.expect(element_js_1.default.controller.get(line.id)).to.equal(line);
        });
        it('should create elements with different identifiers', function () {
            let line1 = new line_js_1.default(100, 100, 100, 100);
            let line2 = new line_js_1.default(100, 100, 100, 100);
            chai.expect(element_js_1.default.controller.get(line1.id)).to.equal(line1);
            chai.expect(element_js_1.default.controller.get(line2.id)).to.equal(line2);
        });
    });
    describe('getters/setters', function () {
        it('should get x1', function () {
            let x1 = 50;
            let line = new line_js_1.default(x1, 100, 100, 100);
        ...
        it('should get y1', function () {
            let y1 = 50;
            let line = new line_js_1.default(100, y1, 100, 100);
        ...
        it('should get x2', function () {
            let x2 = 50;
            let line = new line_js_1.default(100, 100, x2, 100);
        ...
        it('should get y2', function () {
            let y2 = 50;
            let line = new line_js_1.default(100, 100, 100, y2);
        ...
        it('should get x1 and y1, make sure they are different', function () {
            let x1 = 50;
            let y1 = 75;
            let line = new line_js_1.default(x1, y1, 100, 100);
            chai.expect(line.x1).to.equal(50);
        ...
        it('should get x2 and y2, make sure they are different', function () {
            let x2 = 50;
            let y2 = 75;
            let line = new line_js_1.default(100, 100, x2, y2);
            chai.expect(line.x2).to.equal(50);
        ...
        it('should get x1 and x2, make sure they are different', function () {
            let x1 = 50;
            let x2 = 75;
            let line = new line_js_1.default(x1, 100, x2, 100);
            chai.expect(line.x1).to.equal(50);
        ...
        it('should get y1 and y2, make sure they are different', function () {
            let y1 = 50;
            let y2 = 75;
            let line = new line_js_1.default(100, y1, 100, y2);
            chai.expect(line.y1).to.equal(50);
            chai.expect(line.y2).to.equal(75);
        });
    ...
    describe('translate', function () {
        it('should create a line and move it over 10, 10', function () {
            let line = new line_js_1.default(100, 75, 50, 25);
