...
describe('Text', function () {
    describe('constructor', function () {
        it('should create a text with a unique id and add it to the element controller', function () {
            let text = new text_js_1.default(100, 100, "test");
            // chai.expect(text.id).to.equal(`text-0`);
            chai.expect(element_js_1.default.controller.get(text.id)).to.equal(text);
            // chai.expect(Element.count).to.equal(1);
        });
        it('should create elements with different identifiers', function () {
            let text1 = new text_js_1.default(100, 100, "test");
            let text2 = new text_js_1.default(100, 100, "test");
            chai.expect(element_js_1.default.controller.get(text1.id)).to.equal(text1);
            chai.expect(element_js_1.default.controller.get(text2.id)).to.equal(text2);
        });
    });
    describe('getters/setters', function () {
        it('should get x position', function () {
            let x = 50;
            let text = new text_js_1.default(x, 100, "test");
        ...
        it('should get y position', function () {
            let y = 50;
            let text = new text_js_1.default(100, y, "test");
        ...
        it('should get contents', function () {
            ...
            let text = new text_js_1.default(100, 100, textString);
        ...
        it('should set, then get new y position', function () {
            let firstText = "first";
            let text = new text_js_1.default(100, 100, firstText);
