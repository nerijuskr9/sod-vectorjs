...
describe('Rectangle', function () {
    describe('constructor', function () {
        it('should create a rectangle with a unique id and add it to the element controller', function () {
            let rect = new rectangle_js_1.default(100, 101, 100, 200);
            chai.expect(element_js_1.default.controller.get(rect.id)).to.equal(rect);
        });
        it('should create elements with successive identifiers', function () {
            let rect1 = new rectangle_js_1.default(100, 101, 100, 200);
            let rect2 = new rectangle_js_1.default(100, 101, 100, 200);
            chai.expect(element_js_1.default.controller.get(rect1.id)).to.equal(rect1);
            chai.expect(element_js_1.default.controller.get(rect2.id)).to.equal(rect2);
        });
    });
    describe('getters/setters', function () {
        it('should get width', function () {
            let w = 100;
            let rect = new rectangle_js_1.default(100, 100, w, 200);
        ...
        it('should get height', function () {
            let h = 100;
            let rect = new rectangle_js_1.default(100, 100, 100, h);
            chai.expect(rect.width).to.equal(100);
        });
        ...
        it('should get x', function () {
            let x = 75;
            let rect = new rectangle_js_1.default(x, 100, 100, 100);
        ...
        it('should get y', function () {
            let y = 75;
            let rect = new rectangle_js_1.default(100, y, 100, 100);
        ...
        it('should get default fill', function () {
            let rect = new rectangle_js_1.default(100, 100, 100, 100);
