...
class Zoomable extends index_js_1.Interactive {
    /**
    ...
    */
    ...
    mathModeText(x, y, contents) {
        ...
        let internal = new text_js_1.default(0, 0, contents);
        group.root.appendChild(internal.root);
        this.appendChild(group);
        return group;
    }
}
let interactive = new Zoomable(index_js_1.getScriptName(), 500, 500);
