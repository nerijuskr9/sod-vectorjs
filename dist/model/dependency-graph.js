...
const linked_list_js_1 = __importDefault(require("./linked-list.js"));
/**
...
class DependencyGraph {
    ...
    */
    getTopologicalSort() {
        let list = new linked_list_js_1.default();
        let visited = new Set();
    ...
    */
    getTopologicalDependents(node, visited = new Set(), list = new linked_list_js_1.default()) {
        // Mark this node as visited
        visited.add(node);
        // Recursively call this method on dependents of the argument node
