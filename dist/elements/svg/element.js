...
*/
class Element extends base_element_js_1.default {
    ...
    */
    remove() {
        base_element_js_1.default.controller.remove(this);
        this.root.remove();
    }
    /**
    ...
    */
    clear() {
        ...
        while (child = this.root.firstChild) {
            base_element_js_1.default.controller.get(child.id).remove();
        }
    }
    /**
