...
const base_element_js_1 = __importDefault(require("../base-element.js"));
const input_js_1 = __importDefault(require("./input.js"));
const path_js_1 = __importDefault(require("../svg/path.js"));
const circle_js_1 = __importDefault(require("../svg/circle.js"));
...
*/
class Control extends input_js_1.default {
    /**
    ...
    */
    static handleMouseOver(event) {
        if (Control.active == null && !base_element_js_1.default.disable && event.target.tagName == 'circle') {
    ...
    */
    handleMouseDown(event) {
        if (!base_element_js_1.default.disable) {
            event.preventDefault();
