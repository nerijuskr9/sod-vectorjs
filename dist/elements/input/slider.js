...
const control_circle_js_1 = __importDefault(require("./control-circle.js"));
...
*/
class Slider extends input_js_1.default {
    /**
    ...
    */
    constructor(x, y, options) {
        ...
        this._control = new control_circle_js_1.default(x + value, y);
