...
const svg_js_1 = __importDefault(require("../svg/svg.js"));
...
*/
class Plot extends svg_js_1.default {
    /**
    ...
    */
    constructor(fn, options) {
        ...
        if (config.labels) {
            ...
            // draw the title
            let title;
            if (config.title instanceof text_js_1.default) {
    ...
    */
    export() {
        let result = new svg_js_1.default(0, 0, this._width, this._height);
        let margin = 8;
        // trim axis
